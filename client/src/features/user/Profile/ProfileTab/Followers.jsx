...
const Followers = ({ isCurrentUser }) => {
  ...
  const name = (follower) => (
    <Fragment>
      <Link className={classes.userName} to={`/profile/${follower._id}`}>
        {' '}
  ...
  return loading || profile === null ? (
    ...
    <div>
      ...
      {profile.followers.length === 0 ? isCurrentUser || isCurrentUser1 ? (
        <Card className={classes.noFollowingWrapper}>
          <CardHeader
            title={title('You don’t have any followers yet')}
            subheader={subheader(
        ...
        <Card className={classes.noFollowingWrapper}>
          <CardHeader
            title={title('This user don’t have any followers yet')}
            subheader={subheader(
              'When someone follow this user , you’ll see them here'
            )}
          />
        </Card>
      ) : (
            ...
            <CardHeader
              avatar={
                <Avatar
                  ...
                  alt="user profile"
                  src={follower.avatar || '/assets/user.png'}
